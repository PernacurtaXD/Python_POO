...
motorista = Motorista("Leonardo", "20/05/2007", "leo@gmail.com", "2222222-22", Profissão.MOTORISTA,
                      "111111111-12")
print(motorista)


motorista2 = Motorista("José", "10/02/2001", "jo@gmail.com", "1213141.20", Profissão.MOTORISTA, 
                       "22222222-23") 
print(motorista2)